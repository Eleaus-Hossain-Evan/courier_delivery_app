...
enum PickUpTabs { pending, complete }

class PickUpListScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tabController =
        useTabController(initialLength: PickUpTabs.values.length);
    return CustomScrollView(
      controller: scrollController,
      slivers: [
        SliverAppBar(
          centerTitle: true,
          title: AppStrings.pickupList.text.bold.white.xl.make(),
